...
`2022-01-01` INT DEFAULT 0,
  ...
  if ($conn->query($sql) === TRUE) {
  echo "Table january created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table february created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table march created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table april created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table may created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table june created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table july created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table august created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table september created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
$sql = "CREATE TABLE `october` (
  ...
  if ($conn->query($sql) === TRUE) {
    echo "Table october created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table november created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
...
$sql = "CREATE TABLE `december` (
  ...
  if ($conn->query($sql) === TRUE) {
  echo "Table december created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
